...
{
   std::fprintf(stdout, "[BTreeGeneric::create] enter dtid=%lu\n", (unsigned long)dtid); std::fflush(stdout);
   this->dt_id = dtid;
   this->config = config;
   // -------------------------------------------------------------------------------------
   std::fprintf(stdout, "[BTreeGeneric::create] dtid=%lu before allocatePage(meta)\n", (unsigned long)dtid); std::fflush(stdout);
   meta_node_bf = &BMC::global_bf->allocatePage();
   std::fprintf(stdout, "[BTreeGeneric::create] dtid=%lu after allocatePage(meta)\n", (unsigned long)dtid); std::fflush(stdout);
   ...
   guard.unlock();
   // -------------------------------------------------------------------------------------
   std::fprintf(stdout, "[BTreeGeneric::create] dtid=%lu before HybridPageGuard(root)\n", (unsigned long)dtid); std::fflush(stdout);
   ...
   std::fprintf(stdout, "[BTreeGeneric::create] dtid=%lu root guard inited\n", (unsigned long)dtid); std::fflush(stdout);
   // -------------------------------------------------------------------------------------
   ...
   std::fprintf(stdout, "[BTreeGeneric::create] dtid=%lu exit\n", (unsigned long)dtid); std::fflush(stdout);
}
// -------------------------------------------------------------------------------------
