...
#
# Modes:  two_level_readonly  (cxl-recordcache-comparison)
#         two_level_wt        (cxl-WT-comparison)
#         bf-tree             (cxl-WT-comparison)
#         tiered-indexing-zxj (cxl-WT-comparison)
#         hybried-tier-asplos2025 (cxl-WT-comparison)
#
...
main() {
   ...
   log_info "two_level DE     = BP=${TWO_LEVEL_BP_DE} RC=${TWO_LEVEL_RC_DE}"
