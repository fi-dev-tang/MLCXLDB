#!/usr/bin/env python3
"""
Plot 4-system × 7-workload throughput comparison from bench_20260525_233324.
two_level (ours) vs bf-tree / 3T / hybridtier.
Outputs both .pdf and .png with a timestamp suffix.
"""
...
# Mqps for YCSB, TPS for TPC-C. Source: bench_20260525_233324/*.log
YCSB_DATA = {
    "YCSB-A\n(R 50% / U 50%, Zipf 0.99)": {
        "two_level": 1.007, "bf-tree": 2.107, "3T": 0.661, "hybridtier": 1.658,
    },
    "YCSB-B\n(R 95% / U 5%)": {
        "two_level": 2.157, "bf-tree": 2.925, "3T": 0.904, "hybridtier": 1.545,
    },
    "YCSB-C\n(R 100%)": {
        "two_level": 1.883, "bf-tree": 2.806, "3T": 1.807, "hybridtier": 1.590,
    },
    "YCSB-D\n(read-latest 95% / I 5%)": {
        "two_level": 0.462, "bf-tree": 0.256, "3T": 0.044, "hybridtier": 0.790,
    },
    "YCSB-E\n(scan 95% / I 5%)": {
        "two_level": 0.172, "bf-tree": 0.084, "3T": 0.071, "hybridtier": 0.363,
    },
    "YCSB-F\n(R 50% / RMW 50%)": {
        "two_level": 1.024, "bf-tree": 2.023, "3T": 0.660, "hybridtier": 1.317,
    },
}

TPCC_DATA = {
    "two_level": 70745, "bf-tree": 29279, "3T": 60167, "hybridtier": 74757,
}
...
def main():
    ...
    fig.suptitle(
        ...
        "bench_20260525_233324  ·  workingset=2.0 GiB, CXL=2.0 GiB, DRAM=0.5 GiB, theta=0.99, payload=100B",
        fontsize=11,
        y=0.975,
    )
